...
export default function AgentPanel({
  ...
  // On the deployed URL, show a notice instead of allowing chat
  // to prevent open API usage. Works locally without restriction.
  if (!isLocalhost()) {
    return (
      <div className="flex flex-col h-full min-h-0 bg-gray-950 border-r border-gray-800">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 text-center gap-4">
          ...
          <div className="space-y-2">
            <p className="text-sm font-medium text-gray-200">This is a demo</p>
            <p className="text-xs text-gray-500 leading-relaxed">
              To use the full experience, clone the repo and add your own API keys.
            </p>
          </div>
          <a
            href="https://github.com/Abdullah-967/personal_wiki_erasmus_hackathon_claude"
            target="_blank"
